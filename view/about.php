...
<body>
	...
	<section class="container">
		...
		<div class="row-items">
			...
			<div class="container-img-b">
				<img alt="image d'un bateau" src="../public/imgs/tourism.jpg">
			</div>
	...
	<section class="container">
		<div class="row-items">
			<div class="container-img-b">
				<img alt="image des plusieurs monuments au maroc" src="../public/imgs/maroc.jpg">
			</div>
